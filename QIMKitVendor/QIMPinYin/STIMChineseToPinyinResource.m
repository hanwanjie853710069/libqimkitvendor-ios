...
- (void)initializeResource {
    ...
    if (dataMap) {
        ...
        NSString *resourceName = [NSBundle stimDB_myLibraryResourcePathWithClassName:@"STIMKitVendor" BundleName:@"STIMPinYin" pathForResource:@"unicode_to_hanyu_stimDB_pinyin" ofType:@"txt"];
...
+ (STIMChineseToPinyinResource *)getInstance {
    static STIMChineseToPinyinResource *sharedInstance=nil;
