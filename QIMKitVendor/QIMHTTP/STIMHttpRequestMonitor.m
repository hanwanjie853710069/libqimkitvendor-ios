...
@interface STIMHttpRequestMonitor () {
...
@implementation STIMHttpRequestMonitor

+ (instancetype)sharedInstance {
    static STIMHttpRequestMonitor *monitor = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        monitor = [[STIMHttpRequestMonitor alloc] init];
    });
    return monitor;
}
...
- (void)runblock:(dispatch_block_t)block {
    ...
    STIMVerboseLog(@"request count is %lld, selected the %d threads...", _requestCount, pos);
